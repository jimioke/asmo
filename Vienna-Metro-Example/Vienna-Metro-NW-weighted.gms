...
Parameter    weight(S) weights / 1  .56
                                 2  .24
                                 3  .2   /
    ;
* Degree of vertices
...
POSITIVE VARIABLES
  ...
  cs1              bend objective
  cs2              shift objective
  cs3              total edge length objective
...
*$ontext
telcon1(u,v)$e1(u,v)..  x(u) - x(v) =l= lambda(u,v);
telcon2(u,v)$e1(u,v).. -x(u) + x(v) =l= lambda(u,v);
telcon3(u,v)$e1(u,v)..  y(u) - y(v) =l= lambda(u,v);
telcon4(u,v)$e1(u,v).. -y(u) + y(v) =l= lambda(u,v);
*$offtext
...
objtel..  cs3 =e= sum(e1, lambda(e1));
obj.. Z =e= weight('1')*cs1 + weight('2')*cs2 + weight('3')*cs3 ;

$ontext
objbend.. z('bend') =e= sum(ml, sum( (u,v,w), bd(ml,u,v,w) )  );
